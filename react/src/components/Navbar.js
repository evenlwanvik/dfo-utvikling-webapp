    ...
    <div class="container navbar-container">
      ...
      <ul className={click ? "nav-menu active" : "nav-menu"}>
        <li className="nav-item">
          <Link to="localhost:7000" className="h3 nav-links" onClick={closeMobileMenu}> Home </Link>
        </li>
        <li className="nav-item">
          <Link to="/contact" className="h3 nav-links" onClick={closeMobileMenu}> Contact </Link>
        </li>
        <li className="nav-item">
          <a href="http://localhost:7001" className="h3 nav-links" onClick={closeMobileMenu}> Wiki.js </a>
        </li>
      </ul>
    </div>
  </nav>
